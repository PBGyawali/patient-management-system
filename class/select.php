<?php
	class select extends pms{


	function load_department()
	{
		$this->query = "SELECT * FROM departments ORDER BY department_name ASC";
		$result = $this->get_result();
		$output = '';
		foreach($result as $row){
			$output .= '<option value="'.$row["department_id"].'" data-doctor="'.$row["department_id"].'">'.$row["department_name"].'</option>';
		}
		return $output;
	}
	function load_specialization()
	{
		$this->query = "SELECT * FROM specialization ORDER BY specialization_name ASC";
		$result = $this->get_result();
		$output = '';
		foreach($result as $row){
			$output .= '<option value="'.$row["specialization_id"].'" >'.$row["specialization_name"].'</option>';
		}
		return $output;
	}
	function load_doctor($d_id=null)
	{
		$this->query = "SELECT * FROM doctors  ";
		if ($d_id)
		$this->query .=" WHERE department_id= '$d_id' ";
		$this->query .=" ORDER BY doctor_name ASC";
		$result = $this->get_result();
		$output = '';
		foreach($result as $row){
	...
	{
		$html = '
		<select name="facility_currency" id="facility_currency" class="form-control" required>
	...
	function Timezone_list($value=null)
	{
		...
		$html = '
		<select name="facility_timezone" id="facility_timezone" class="form-control" required>
